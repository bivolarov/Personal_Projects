...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <ul>
 <li><a href="main_page_2.php">Accueil</a></li>
 ...
 <li><a href="../deconnect.php">Deconnexion</a></li>
     ...
     -->
      ...
      <br>
        ...
        <form id = "avis_station" method="post" action="../services/noteStation.php" >
        </form>
      ...
      <form class="comment" id = "comment" action = "../services/createPost.php" method="post">
      </form>
  ...
  <script type="text/javascript" src = "../javascript/mainPageScript2.js"> </script>
